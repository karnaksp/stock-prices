...
Готовые preset-сценарии остаются ручными примерами, а случайный шортс, ролик дня и недельный план собираются без LLM из тикерной вселенной проекта. Подробные команды лежат в разделе [Telegram-запросы](telegram.md).
