...
После каждого MP4 бот присылает черновик поста для Пульса. Для готовых сценариев это ручной текст, для остальных запросов - skeleton с заголовком, хуком, фактическими параметрами, вопросом для обсуждения и монтажным настроением.
