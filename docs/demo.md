...
После каждого MP4 бот присылает черновик поста для Пульса. Для готовых сценариев это ручной текст, для остальных запросов - нейтральная заготовка по тикерам, периоду, валюте и инвестиционным параметрам.
