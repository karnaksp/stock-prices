...
=== "Telegram"
    ...
    Бот не использует LLM: `/shorts` открывает ручные примеры, `случайный шортс`, ролик дня и недельный план собираются из тикерной вселенной, а запрос с тикерами ставит в очередь конкретный ролик.
