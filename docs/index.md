...
/plan, план пульса и контент-план показывают недельную сетку готовых выпусков с кнопками запуска, /plan_shorts и снять план ставят все shorts этой сетки в очередь, /publish_day и снять день ставят шортс дня в очередь и сразу отправляют пакет для поста, /today и шортс дня ставят выпуск текущего дня, а /today_kit и пакет дня открывают пакет текущего дня без рендера
