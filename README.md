...
```text
/menu                  единое меню с прямыми top-shorts кнопками, идеями, примерами, draft-ами и очередью
...
Текст для Пульса       бот присылает черновик поста после каждого MP4: заголовок, хук, вопрос и монтажное настроение
