...
Бот не использует LLM. Он принимает команду или текстовый запрос, ставит генерацию в очередь, рендерит MP4 и отправляет результат обратно в чат. Случайные шортсы и недельный план собираются из тикерной вселенной проекта, а fixed preset остаются ручными сценариями.
...
| Случайный шортс | `случайный шортс` |
