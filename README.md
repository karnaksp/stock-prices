...
```text
/menu                  единое меню с кнопками идей, примеров, draft-ов, случайных прогонов и очереди
